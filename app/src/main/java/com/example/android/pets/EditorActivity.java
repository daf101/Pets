...
public class EditorActivity extends AppCompatActivity
    ...
    private void savePet() {
        ...
        // If the user hasn't specified any input, just finish the activity:
        ...
        // Checking if we're in edit pet or new pet mode:
        if (mCurrentPetUri == null) {
            // new pet mode:
            ...
            rowsUpdated = getContentResolver().update(mCurrentPetUri,values,selectionClause,selectionArgs);
        }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            breed = cursor.getString(breedColumnIndex);
